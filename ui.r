...
cochranelibrary.com/about/about-cochrane-reviews).")
      ...
      tabItem(tabName = "eda",
              ...
              fluidRow(
                box(width = 12,
                    h4("Introduction"),
                    p("The literture about human health impacts of living near production animals is quite limited. After conducting an exhaustive search, our team identified  studies consisting of 10 study populations to include in the analysis.
                    Those original 16 studies were conducted in only three countries. The health outcomes were lower and upper respiratory tracts, MRSA, other infectious disease, neurological, 
                    psychological, dermatological, otologic, ocular, gastrointestinal, stress and mood, and other non-infectious health outcomes.
                      The health outcomes displayed in the side bar were selected because these were analyzed in more than two papers (see Timeline). For this update version,  we have identified 20 additional relevant paper approaching this topic" ),
